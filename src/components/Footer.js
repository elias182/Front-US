  ...
  return (
    <div className="footer d-flex justify-content-between align-items-center p-3">
      <div className="playing-now d-flex align-items-center">
        {currentSong && currentSong.portada ? (
          <img src={`http://127.0.0.1:8000/${currentSong.portada}`} alt="Album Cover" className="album-cover me-3" />
        ) : (
    ...
    {isPlaying ? <FaPause /> : <FaPlay />}
      ...
      {currentSong && (
        ...
        >
          <source src={`http://127.0.0.1:8000/${currentSong.archivo_audio}`} type="audio/mpeg" />
